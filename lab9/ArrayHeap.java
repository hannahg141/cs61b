...
public class ArrayHeap<T> {
    ...
    /* Adds the given noden as the right child of the node at the given index. */
    ...
    private void bubbleDown(int index) {
        while (getNode(index) != null && getNode(getLeftOf(index)) != null && getNode(getRightOf(index)) != null
                && (getNode(index).priority() > getNode(getRightOf(index)).priority()
                || getNode(index).priority() > getNode(getLeftOf(index)).priority())) {
