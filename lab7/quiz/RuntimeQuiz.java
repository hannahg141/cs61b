...
public class RuntimeQuiz {
    ...
    public void f5(int n) {
        int[] array = {1, 2, 3};
        while (n > 0) {
            f1(array); //f1 is linear as the array grows, but our array is always same size
            n = n / 2;
        }
    }

    public static Asymptotic f6_notation = Asymptotic.BIG_O; //or BIG_THETA
    ...
    public static Runtime f7_runtime = Runtime.EXPONENTIAL; //recursion is exponential
